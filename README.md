...
* The results in Figs. 14 and 15 show a normal distribution of allele frequencies in mainland ancestor populations. There is a large number of fixed alleles and some intermediate alleles. On the other hand, Figs. 10 and 11 show several intermediate allele frequencies in island fox populations. Such results are indicative of a population bottleneck. This is supported by the results in Fig. 2, which show a drastic decline in island fox populations on all islands around the year 2000. 
